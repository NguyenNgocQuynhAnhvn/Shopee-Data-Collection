...
def get_start_page(save_file):
    """Xác định trang bắt đầu dựa trên số sản phẩm đã lưu trong file CSV."""
...
if __name__ == "__main__":
    ...
    start_page = get_start_page(save_file)

    for brand_url in config['brand_urls']:
        for page in range(20):  # Thay đổi số trang nếu cần
